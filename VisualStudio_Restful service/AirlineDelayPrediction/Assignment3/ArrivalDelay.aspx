<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ArrivalDelay.aspx.cs" Inherits="FinalProject.ArrivalDelay" %>
            ...
            $("#txtDropBoxHour").change(function () {
                ...
                $.ajax({
                    ...
                    success: function (xml) {
                        ...
                        $("#txtVisibility").val(visi);
                        $("#txtDewpoint").val(dewpoint);
                    }
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Arrival Delay Prediction</h4>
                            </div>
                            <div class="content">
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           ...
                                           <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Arrival Time </label><asp:TextBox class="form-control" ID="txtArrivalTime" runat="server" type="text" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Departure Delay</label><asp:TextBox class="form-control" ID="txtDepartureDelay" runat="server" type="text" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Flight Num</label><asp:TextBox class="form-control" ID="txtFlightNum" runat="server" type="text" />
                                            </div>
                                        </div>
                                            <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Visibility</label><asp:TextBox class="form-control" ID="txtVisibility" runat="server" type="text" />
                                            </div>
                                        </div>
                                    </div>
...
<div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <asp:TextBox class="form-control" runat="server" ID="txtRegression" />
                                            </div>
                                        </div>
                                    </div>
